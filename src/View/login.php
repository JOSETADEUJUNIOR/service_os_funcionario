                                             ...
                                             <fieldset>
                                                 <label class="block clearfix">
                                                     <span class="block input-icon input-icon-right">
                                                         <input type="text" class="form-control obg" id="login" autocomplete="off" placeholder="E-mail" />
                                                 ...
                                                 <div class="clearfix col-md-12">
                                                     ...
                                                     <button name="btn_acessar" onclick="return ValidarAcesso('form_login_func')" class="width-100 pull-right btn btn-sm btn-primary">
