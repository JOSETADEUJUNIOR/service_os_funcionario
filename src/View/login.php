                 ...
                 <div class="form">
                     ...
                     <div style="margin-top: 20px;">
                         <form id="form_login_func" action="login.php" method="post">
                             <h5 style="text-align: center;"><i class="ace-icon fa fa-lock"></i>&nbsp;&nbsp;Acesso para funcionário</h5>
                             ...
                             <button type="submit" name="btn_acessar" onclick="return ValidarAcesso('form_login_func')"><i class="ace-icon fa fa-key"></i> Entrar</button>
                         </form>
